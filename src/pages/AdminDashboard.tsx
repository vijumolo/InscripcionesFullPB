...
import { deleteAllParticipantRecords, deleteParticipantRecord, fetchLatestEvent, isAdminAuthenticated, listParticipants, refreshAdminAuth, saveEvent, signOutAdmin } from '../lib/api';
...
export const AdminDashboard = () => {
    ...
    const checkAuthAndLoadData = async () => {
        ...
        try {
            const authStillValid = await refreshAdminAuth();
            if (!authStillValid) {
                navigate('/admin');
                return;
            }
    ...
    const handleDeleteAll = async () => {
        ...
        try {
            await deleteAllParticipantRecords();
            setParticipants([]);
